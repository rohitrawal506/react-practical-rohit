...
const CharacterInformation = ({ character }: CharacterCardProps) => {

  return (
    <div className="h-full max-h-full xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6 bg-gray-50  p-4 drop-shadow-xl">
